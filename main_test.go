...
func (e mockEmailer) SendToken(domain *models.Domain, token string) error { return nil }
func (e mockEmailer) SendSuccess(domain *models.Domain) error             { return nil }
func (e mockEmailer) SendFailure(domain *models.Domain, msg string) error { return nil }
